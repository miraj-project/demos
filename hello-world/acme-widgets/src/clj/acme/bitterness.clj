...
(println "loading miraj.demos.hello-world.bitterness")

;; in the lib, this will be exported as miraj.demos.hello-world.widgets/bitterest
(miraj/defcomponent bitterest :html bitterness-bitterest
  "bitter"
  (:codom (h/span "Bitterest")))

(miraj/defcomponent bitterer :html bitterness-bitterer
  "bitterer"
  (:codom (h/span "Bitterer")))

;; in the lib, this will be exported as miraj.demos.hello-world.widgets/bitter
(miraj/defcomponent bitter :html bitterness-bitter
