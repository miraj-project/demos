(def +project+ 'tmp.components/salutations)
...
(deftask build []
  ...
  (comp
   (miraj/compile :component #{'miraj.demo.greeting 'miraj.demo.adieu}
...
#_(comp (miraj/compile :component #{'miraj.demo.greetings.hello}
                       :keep true :pprint true :verbose true)
