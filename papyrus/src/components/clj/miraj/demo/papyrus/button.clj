...
(println "loading miraj.demo.papyrus.button")

(defprotocol HelloWorldProtocol
  (foo [this])
  (bar [this x]))

;; in the lib, this will be exported as miraj.demo.papyrus/button
(miraj/defcomponent button :html papyrus-button
 ...
 span {background-color:#E0F2F1;}")
  ...
  (mouseover [x] (del/mouseover x)) ; (.log js/console "MOUSEOVER"))
                                        ...
                                        ;(-> basic var meta)
(println "loaded miraj.demo.papyrus.button")
