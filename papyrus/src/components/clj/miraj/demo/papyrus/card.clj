...
(println "loading miraj.demo.papyrus.card")

(defprotocol HelloWorldProtocol
  (foo [this])
  (bar [this x]))

;; in the lib, this will be exported as miraj.demo.papyrus/card
(miraj/defcomponent card :html papyrus-card
 ...
 span {background-color:#E0F2F1;}")
  ...
  (mouseover [x] (del/mouseover x)) ; (.log js/console "MOUSEOVER"))
                                        ...
                                        ;(-> basic var meta)
(println "loaded miraj.demo.papyrus.card")
